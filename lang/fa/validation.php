...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'started_at' => [
            'after' => 'ساعت ورود باید بعد از تمامی زمان های پایان باشد.',
        ],
        'finished_at' => [
            'after' => 'ساعت خروج باید بعد از ساعت ورود باشد.',
            'before' => 'ساعت خروج باید قبل از ساعت ورود های ورود قبلی باشد.',
        ],
    ],
